...
using SON_eStore.Providers;
using SON_eStore.Results;
...
namespace SON_eStore.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> ChangePassword(ChangePasswordBindingModel model)
        {
            ...
            if (!result.Succeeded)
            {
                return Content(System.Net.HttpStatusCode.BadRequest, "Invalid password");
            }
        ...
        [Route("Register")]
        [HttpPost]
        public async Task<IHttpActionResult> Register(StaffViewModel model)
        {
            try
            {
                ...
                var user = new ApplicationUser
                {
                    ...
                    UserName = uname,
                    Email = uname+"@sonestore.com",
                    Fname = model.Fname,
                    LName = model.Lname,
                    // PhoneNumber = model.phone,
                    Reg_date = DateTime.UtcNow,
                    staffType = model.staffType,
                    stateOffice = model.stateOffice,
                    regionalOffice = model.regionalOffice,
                    dept_name = (d != null) ? d.dept_name : null,
                    dept_id = model.dept_id,
                    unit_id = model.unit_id,
                    unit_name = (u != null) ? u.unit_name : null,
                     EmailConfirmed = true,
                ...
                {
                    if (!UserRole.Contains(user.rolename))
                    {
